...
System.register(["angular", "lodash", "app/core/config", "app/core/core_module", "app/plugins/panel/unknown/module"], function (exports_1, context_1) {
    "use strict";
        ...
        function getModule(scope, attrs) {
            switch (attrs.type) {
                ...
                case 'app-config-ctrl': {
                    ...
                    return System.import(model_1.module).then(function (appModule) {
                        return {
                ...
                case 'app-page': {
                    ...
                    return System.import(appModel_1.module).then(function (appModule) {
                        return {
